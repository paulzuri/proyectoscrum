        ...
        <>
            <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                ...
                <div className="flex items-center p-8 bg-white shadow rounded-lg">
                    ...
                    <div>
                        <span className="block text-2xl font-bold">{data?.totalStock}</span>
                        <span className="block text-gray-500">Stock Total</span>
                    </div>
                </div>
                ...
                {/* Tarjeta de Número Total de Productos */}
                <div className="flex items-center p-8 bg-white shadow rounded-lg">
                    ...
                    <div>
                        ...
                        <span className="block text-gray-500">Productos Totales</span>
                    </div>
                </div>
                </section>
